...
module.exports = async (context) => {
    ...
    try {
        ...
        const getGreeting = () => {
            ...
            if (currentHour >= 5 && currentHour < 12) return '𝐆ᴏᴏᴅ ᴍᴏʀɴɪɴɢ';
            if (currentHour >= 12 && currentHour < 18) return '𝐍ɪᴀᴊᴇ?';
            if (currentHour >= 18 && currentHour < 22) return '𝐆ᴏᴏᴅ ᴇᴠᴇɴɪɴɢ';
            return '𝐆ᴏᴏᴅɴɪɢʜᴛ';
        };
        ...
        let menuText = `${getGreeting()}, 𝐀ғʀɪᴄᴀ\n\n`;
