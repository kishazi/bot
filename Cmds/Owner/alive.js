module.exports = async (context) => {
  ...
  const url = 'https://github.com/engineermarcus/START-MD2';
  const murl = 'https://whatsapp.com/channel/0029Vb9EZIl60eBdl8fIY10p';
  ...
  const con = {
    key: {
      ...
      ...(m.chat ? { remoteJid: '254725693306@s.whatsapp.net' } : {}),
    },
    message: {
      contactMessage: {
        displayName: name,
